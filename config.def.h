...
static const char *fonts[]          = { "Iosevka:pixelsize=14:antialias=true:autohint=true", "Hack Nerd Font Mono:pixelsize=16:antialias=true:autohint=true" };
...
static const char col_cyan2[]        = "#009cad";
...
/* tagging */
static const char *tags[] = { "Code", "Web", "Code2", "4", "5", "6", "7", "Music", "Notes" };
